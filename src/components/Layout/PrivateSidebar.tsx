...
const PrivateSidebar: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className="flex flex-col flex-1 min-h-0 bg-white border-r border-gray-200">
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            ...
            <div className="px-4 mb-6">
              <div className="bg-gradient-to-r from-gold-50 to-cream-50 rounded-xl p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-charcoal-600 capitalize">
                      {user?.businessType} • {user?.status === 'approved' ? 'Activo' : 'Pendiente'}
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* Mobile Sidebar - will be handled by the header */}
    </>
  );
};
